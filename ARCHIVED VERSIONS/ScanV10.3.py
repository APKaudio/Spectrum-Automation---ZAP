...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        open_folder_button = tk.Button(output_frame, text="Open Folder", command=self.open_output_folder)
        open_folder_button.grid(row=0, column=2, padx=5, pady=2)
    ...
    def open_output_folder(self):
        ...
        if not folder_path:
            messagebox.showwarning("Open Folder", "Output folder path is not specified.")
            return
