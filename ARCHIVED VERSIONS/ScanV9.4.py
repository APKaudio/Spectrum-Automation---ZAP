...
class ScanApp:
    def __init__(self, master):
        ...
        self.rbw_config_var = tk.StringVar(value="1000")
        self.vbw_config_var = tk.StringVar(value="1000")
    ...
    def create_widgets(self):
        ...
        tk.Label(config_frame, text="Set RBW (e.g., 1000, 10000):").pack(pady=(5, 2), anchor="w")
