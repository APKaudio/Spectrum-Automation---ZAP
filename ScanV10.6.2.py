...
class App(tk.Tk):
    ...
    def create_widgets(self):
        ...
        # Configure a style for blue text
        self.style = ttk.Style()
        self.style.configure("Mon.Treenode", foreground="blue")
    ...
    def load_selected_preset(self):
        ...
        try:
            if write_safe(self.inst, command):
                messagebox.showinfo("Preset Loaded", f"Successfully loaded preset: {selected_preset_name}")
