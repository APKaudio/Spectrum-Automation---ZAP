...
class App(tk.Tk):
    def __init__(self):
        ...
        self.instrument_model = "Unknown" # Initialize instrument model
    ...
    def connect_instrument(self):
        ...
        try:
            ...
            if instrument_id:
                ...
                model_match = re.search(r'N9342CN|N9340B', instrument_id) # Updated regex to specifically match these models
    ...
    def disconnect_instrument(self):
        ...
        if self.inst:
            try:
                self.inst.close()
                self.inst = None
                self.instrument_model = "Unknown" # Reset model on disconnect
