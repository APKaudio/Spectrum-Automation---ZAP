    ...
    for i in range(last_scanned_band_index, len(selected_bands)):
        ...
        while current_segment_start_freq_hz < band_stop_freq_hz:
            ...
            if max_hold_time > 0:
                ...
                app_instance.after(0, app_instance._update_console_line, "✅", False) # Print final message, no overwrite on this one
...
def plot_data(scanned_data, csv_file_path, include_tv_markers=True, include_gov_markers=True):
    """
