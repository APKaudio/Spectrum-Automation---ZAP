        ...
        while current_segment_start_freq_hz < band_stop_freq_hz:
            ...
            if max_hold_time > 0:
                for sec_wait in range(int(max_hold_time), 0, -1):
                    ...
                    # Use the new helper function to update console line safely
                    app_instance.after(0, app_instance._update_console_line, display_text, True) 
                    time.sleep(1)
                app_instance.after(0, app_instance._update_console_line, "✅ Max Hold wait complete.\n", True)
