...
class App(tk.Tk):
                ...
                try:
                    with open(current_csv_file_path, 'w', newline='') as current_csv_file:
                        ...
                        if self.open_html_after_complete_var.get():
                            ...
                            # Pass the derived HTML plot path
                            self.after(0, self.generate_single_scan_plot_and_open_wrapper, scanned_data, plot_suffix, html_plot_path_for_single_scan) 
    ...
    def generate_single_scan_plot_and_open_wrapper(self, scanned_data, plot_title_suffix, output_html_path):
