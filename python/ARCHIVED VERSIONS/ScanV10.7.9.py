...
class App(tk.Tk):
                ...
                try:
                    with open(current_csv_file_path, 'w', newline='') as current_csv_file:
                        ...
                        if not self.scanning:
                            ...
                            if scanned_data:
                                plot_suffix = f"{scan_name}_{rbw_str}_{hold_str}_{datetime_str}_INTERRUPTED"
    ...
    def generate_average_plot(self):
        ...
        # Regex to extract datetime string from filename: e.g., MyScan_RBW####_HOLD##_YYYYMMDD_HHMMSS.csv
